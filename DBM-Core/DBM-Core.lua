...
DBM = {
	Revision = parseCurseDate("20260919215039"), -- hardcoded: bump manually when cutting a release
	DisplayVersion = "1.0.8-ygg", -- hardcoded base version
}
