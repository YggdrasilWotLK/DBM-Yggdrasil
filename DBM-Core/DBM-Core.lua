...
DBM = {
	Revision = parseCurseDate("20260919183012"), -- hardcoded: bump manually when cutting a release
	DisplayVersion = "1.0.4-ygg", -- hardcoded base version
}
