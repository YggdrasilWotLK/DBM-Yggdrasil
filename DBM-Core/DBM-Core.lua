...
DBM = {
	Revision = parseCurseDate("20260919184855"), -- hardcoded: bump manually when cutting a release
	DisplayVersion = "1.0.5-ygg", -- hardcoded base version
}
