...
local timerSleepingFogCD		= mod:NewCDTimer(150, 24814, nil, nil, nil, 3)--Core 120-150s RNG; max bar (was 16.8)
...
function mod:OnCombatStart(_, yellTriggered)
	if yellTriggered then
		...
		timerSleepingFogMinCD:Start(18.4-delay)--Core first 12.5-20s (was commented out)
