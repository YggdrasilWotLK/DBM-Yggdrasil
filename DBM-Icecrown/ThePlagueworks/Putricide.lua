...
local warnMutatedPlague				= mod:NewStackAnnounce(72451, 3, nil, "Ranged|Melee|Tank|Healer|RemoveEnrage") -- Phase 3 ability

local timerMutatedPlagueCD			= mod:NewCDTimer(10, 72451, nil, "Ranged|Melee|Tank|Healer|RemoveEnrage", nil, 5, nil, DBM_COMMON_L.TANK_ICON)				-- 10 to 11
