...
-- General
local timerCombatStart		= mod:NewCombatTimer(40.9)
...
local specwarnRuneofBlood	= mod:NewSpecialWarningTaunt(72410, true, nil, "Tank", 1, 2)
local specwarnRuneofBloodYou= mod:NewSpecialWarningYou(72410, true, nil, nil, 1, 2)


local timerRuneofBlood	= mod:NewTimer(20, "Rune of Blood", 72410, "Tank", nil, 1, nil, DBM_COMMON_L.TANK_ICON, nil, 3) --Nick bookmark
local timerRuneofBlood2	= mod:NewTimer(20, "Next Rune of Blood", 72410, "Tank", nil, 1, nil, DBM_COMMON_L.TANK_ICON, nil, 3) --Nick bookmark
