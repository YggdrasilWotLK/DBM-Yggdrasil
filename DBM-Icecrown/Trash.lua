...
-- local specWarnBlade				= mod:NewSpecialWarningMove(70305) -- NICK - Disabled because annoying and not productive on most WotLK 3.3.5a servers.
...
--function mod:SPELL_DAMAGE(_, _, _, destGUID, _, _, spellId) -- NICK - Disabled because annoying and not productive on most WotLK 3.3.5a servers.
--	if spellId == 70305 and destGUID == UnitGUID("player") --and self:AntiSpam() then NICK - Disabled because annoying and not productive on most WotLK 3.3.5a servers.
--		specWarnBlade:Show() -- NICK - Disabled because annoying and not productive on most WotLK 3.3.5a servers.
--	end -- NICK - Disabled because annoying and not productive on most WotLK 3.3.5a servers.
--end -- NICK - Disabled because annoying and not productive on most WotLK 3.3.5a servers.
